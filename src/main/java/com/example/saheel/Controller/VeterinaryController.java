...
public class VeterinaryController {
    ...
    public ResponseEntity<ApiException> addVeterinary(@PathVariable Integer stable_Id, @RequestBody Veterinary veterinary) {
    ...
    public ResponseEntity<ApiException> updateVeterinary(@PathVariable Integer stable_Id, @PathVariable Integer veterinary_Id, @RequestBody Veterinary veterinary) {
    ...
    public ResponseEntity<ApiException> deleteVeterinary(@PathVariable Integer veterinary_Id) {
